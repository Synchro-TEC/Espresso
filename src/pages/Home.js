      ...
      <div>
        <div className="out-home">
          <div className="home-hero" style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/images/bg-hero.png` }}>
            <div className="sv-row--with-gutter">
              <div className="sv-column _25 sv-pt--50">
                <img className="sv-ma--10" src={process.env.PUBLIC_URL + '/images/maquina.svg'} />
              </div>
              <div className="sv-column _75 sv-ph--100 sv-pt--50">
        ...
        <div className="out-home-icons">
          <div className="home-icons">
            <div className="sv-row sv-pt--80">
              <div className="sv-column sv-text-center sv-ph--30">
                <div>
                  <img
                    className="sv-ma--10"
                    height="105"
        ...
        <div className="out-devtools">
          <div className="devtools">
            <div className="sv-row sv-pt--50">
              <div className="sv-column _25">
                <img
